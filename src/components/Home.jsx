      ...
      <div className='container mx-auto px-4 py-10'>
          ...
          <form className='flex flex-col gap-4 p-6 border border-red-500 rounded-lg' onSubmit={handleSubmiit}>
              ...
              <div className='grid grid-cols-2 gap-4'>
                <div>
                  ...
                  <input
                    ...
                    className='w-full h-10 rounded-md border border-red-500 bg-black cursor-pointer'
                  />
                </div>
                <div>
            ...
            <div className='space-y-2'>
              ...
              <input
                ...
                className='w-full h-8 overflow-hidden rounded-md border border-red-500 bg-black cursor-pointer'
              />
            </div>
            ...
            <button
              type='submit'
              className='w-full p-2 rounded-md border border-red-500 bg-red-500 text-gray-100 hover:bg-red-600 transition-colors'
            >
              Generate Banner
            </button>
          </form>
        ...
        {showbanner && (
          <div className="mt-10 flex flex-col items-center font-serif space-y-4 px-4">
            <div
              ref={bannerRef}
              className="w-full max-w-[400px] rounded-lg p-4"
              style={{
...
<div className='flex items-center gap-1 min-w-0'>
                  <ImSphere className="" />
                <p  className="text-gray-300"> <a className='text-gray-300' href= {formData.porfolio}>  {formData.porfolio}</a></p>
                </div>
              

              <div className="mt-1 flex flex-wrap items-center justify-end gap-2 text-gray-200">
                <p className='text-base md:text-md font-semibold'>Stack:</p>
